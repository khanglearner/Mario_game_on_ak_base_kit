...
/******************************************************************************/
/*  MARIO GAME task define
 */
/******************************************************************************/
	/*TIMER*/
#define MAR_GAME_TIME_TICK_INTERVAL		(100)

/*	SIGNAL SCREEN MARIO GAME ON	*/
enum 
	{
...
// enum
// 	{
// 		MAR_GAME_DISPLAY_OVER_DOWN_PRESSED,//	 = AK_USER_DEFINE_SIG,
// 		MAR_GAME_DISPLAY_OVER_MODE_PRESSED,
// 		MAR_GAME_DISPLAY_OVER_ON_TICK
// 	};

	/*SIGNAL FOR MARIO MAP*/
enum {
	...
	/*SIGNAL FOR MARIO CHARACTER*/
enum {
		MAR_GAME_MARIO_SETUP_SIG = AK_USER_DEFINE_SIG,
		MAR_GAME_MARIO_RESET_SIG,
		MAR_GAME_MARIO_UPDATE_ON_TICK_SIG,
		MAR_GAME_MARIO_JUMP_SIG,
		MAR_GAME_MARIO_FALLING_SIG,
		
		MAR_GAME_MARIO_MOVE_LEFT_SIG,
		MAR_GAME_MARIO_MOVE_RIGHT_SIG
	};	
/*****************************************************************************/
