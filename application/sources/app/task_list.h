...
enum {
	...
	/*MARIO GAME ON*/
	MAR_GAME_TASK_DISPLAY_GAME_ON_ID,
	MAR_GAME_TASK_MAP_ID,
	MAR_GAME_TASK_MARIO_ID,
	MAR_GAME_TASK_GAME_OVER_ID,
...
/*MARIO GAME TASK define on task_list.h*/
/****************************************************************************** */
/*MARIO	 GAME TASK*/
/*****************************************************************************/
extern void task_scr_mar_game_on_handle(ak_msg_t*);
extern void task_scr_mar_game_over_handle(ak_msg_t*);
extern void task_mar_map_handle(ak_msg_t*);

/*MARIO*/
extern void task_mar_game_mario_handle(ak_msg_t *msg);
