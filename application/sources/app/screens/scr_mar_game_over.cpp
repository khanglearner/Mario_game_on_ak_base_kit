...
/* View - game over */
/*****************************************************************************/
static void view_scr_mar_game_over();

view_dynamic_t dyn_view_item_mar_game_over = {
	{
		.item_type = ITEM_TYPE_DYNAMIC,
	},
	view_scr_mar_game_over
};

view_screen_t scr_mar_game_over = {
	&dyn_view_item_mar_game_over,
	ITEM_NULL,
	ITEM_NULL,
...
void task_scr_mar_game_over_handle(ak_msg_t* msg) {
	switch (msg->sig) {
	case SCREEN_ENTRY: {
	...
	case AC_DISPLAY_BUTTON_DOWN_RELEASED: {
		...
		/*eeprom_write(	EEPROM_SCORE_START_ADDR, \
						(uint8_t*)&gamescore, \
						sizeof(gamescore));*/
		SCREEN_TRAN(task_scr_mar_game_on_handle, &scr_mario_game);
	}	
		BUZZER_PlayTones(tones_cc);
		break;
